...
%SIMPLEGUI MATLAB code file for SimpleGUI.fig
...
%
%      SIMPLEGUI('Property','Value',...) creates a new SIMPLEGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to SimpleGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      SIMPLEGUI('CALLBACK') and SIMPLEGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in SIMPLEGUI.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 25-May-2017 13:39:42
...
[mod, Opt_signal] = afoc_transmitter;
mod
...
BER = afoc_receiver(mod, Opt_signal);
